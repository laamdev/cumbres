...
export const WeatherWidget = ({ weather }: { weather: WeatherData }) => {
  return (
    <section className="grid grid-cols-5 divide-x-2 divide-branding-green rounded-xl -mt-5 z-50 relative bg-branding-yellow p-2.5 text-branding-green sm:p-5">
      ...
      <div className="col-span-3 grid grid-cols-4 place-items-center gap-2.5">
        <DetailContainer>
          <DetailLabel>
