    ...
    <div className="relative z-40 mx-auto flex w-full max-w-5xl flex-1 overflow-hidden">
      <div className="z-0 flex-1 overflow-y-scroll">
          ...
          <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-5">
            ...
            >
              <Link href="/">
                <Logo
                  className={cn(
                    "tw-transition size-7 sm:size-10",
                    color === "green" &&
                      "fill-branding-green hover:fill-branding-green/90",
                    color === "yellow" &&
                      "fill-branding-yellow hover:fill-branding-yellow/90"
                  )}
                />
                {/* <Mountains
                  weight="fill"
            ...
            <motion.nav
              ...
              className="flex space-x-4 text-xs font-medium text-neutral-400"
            >
              <SignedOut>
        ...
        {/* <main className="px-8 pt-28">
          <h1 className="h-10 w-4/5 rounded bg-neutral-200 text-2xl font-bold" />
          <div className="mt-8 space-y-6">
            {[...Array(2).keys()].map((i) => (
              <div key={i} className="space-y-2 text-sm">
                <p className="h-4 w-5/6 rounded bg-neutral-200" />
                <p className="h-4 rounded bg-neutral-200" />
                <p className="h-4 w-4/6 rounded bg-neutral-200" />
              </div>
            ))}
